...
export default function PlacesPage() {
    ...
    // function addPhotoByLink(header, description) {
    //     return (
    //         <>
    //             {inputHeader(header)}
    //             {inputDescription(description)}
                        ...
                        <form className="text-left ">
                            ...
                            <label >
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button onClick={pd} className="bg-gray-200 px-4 rounded-2xl">Add&nbsp;photo</button>
                                </div>
                                <div className="mt-2">
                                    <button onClick={pd} className="flex gap-1 justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
